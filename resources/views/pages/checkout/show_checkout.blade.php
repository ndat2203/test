            ...
            <div class="row"  style="margin-bottom:100px;">
                ...
                <div >
                    <div class="shopper-info">
                        <h4 style="margin-bottom:25px;">Điền thông tin giao hàng</h4>
                        ...
                        <div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="shipping_email" class="form-control" placeholder="Email" value="{{ old('shipping_email') }}">
                                </div>

                                <div class="form-group">
                                    <input type="text" name="shipping_name" class="form-control" placeholder="Họ tên" value="{{ old('shipping_name') }}">
                                </div>

                                <div class="form-group">
                                    <input type="text" name="shipping_address" class="form-control" placeholder="Địa chỉ" value="{{ old('shipping_address') }}">
                                </div>

                                <div class="form-group">
                                    <input type="text" name="shipping_phone" class="form-control" placeholder="Số điện thoại" value="{{ old('shipping_phone') }}">
                                </div>

                                <div class="form-group">
                                    <textarea name="shipping_note" class="form-control" placeholder="Ghi chú đơn hàng" rows="4">{{ old('shipping_note') }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    <div class="form-group">
...
document.getElementById("checkoutForm").addEventListener("submit", function(event) {
    ...
    let fields = ["shipping_email", "shipping_name", "shipping_address", "shipping_phone"];
    ...
    fields.forEach(field => {
        ...
        if (!input.value.trim()) {
            input.nextElementSibling.innerHTML = "Trường này không được để trống!";
            isValid = false;
        }
    });

    // Kiểm tra định dạng email
    let email = document.getElementById("shipping_email").value.trim();
    let emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    if (email && !emailRegex.test(email)) {
        document.getElementById("shipping_email").nextElementSibling.innerHTML = "Email không hợp lệ!";
        isValid = false;
    }
    ...
    if (phone && !phoneRegex.test(phone)) {
        document.getElementById("shipping_phone").nextElementSibling.innerHTML = "Số điện thoại không hợp lệ!";
        isValid = false;
    }
