                    ...
                    <tbody>
                            ...
                            <tr>
                                <td class="cart_product">
                                    <a href="">
                                        <img src="{{ URL::to('public/upload/product/'.$value->attributes->image) }}" alt="" width="50">
                                    </a>
                                </td>
                                ...
                                <td class="cart_quantity">
                                    <div class="cart_quantity_button">
                                        <a class="cart_quantity_up" data-id="{{ $value->id }}" href="javascript:void(0)"> + </a>
                                        <input class="cart_quantity_input" type="text" name="quantity" value="{{ $value->quantity }}" autocomplete="off" size="2" readonly>
                                        <a class="cart_quantity_down" data-id="{{ $value->id }}" href="javascript:void(0)"> - </a>
                                    </div>
                                </td>
                                <td class="cart_total">
                                ...
                                <td class="cart_delete">
                                    <a class="cart_quantity_delete" href="{{ URL::to('/delete-from-cart/'.$value->id) }}"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
